...
#'   assertIsAnImplicitInteger assertIsTx2gene camel fixNA localOrRemoteFile
#'   makeNames printString readFileByExtension readYAML removeNA
...
#' @importFrom S4Vectors aggregate DataFrame merge tail
