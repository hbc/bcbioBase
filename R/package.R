...
#'   dl import makeNames makeSampleData metadata<- na.omit packageName
#'   packageVersion printString rbindToDataFrame realpath removeNA sanitizeNA
#'   str_match tail toInlineString ul
