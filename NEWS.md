## bcbioBase 0.4.2 (2019-05-12)

Maintenance release, ensuring compatibility with basejump v0.10 release series.

### Minor changes

- bcbioBase is now pinned against R 3.5.
- Updated Travis CI (now dockerized) and AppVeyor CI configuration.
- Updated unit tests to use `test.acidgenomics.com` URL.
